...
<div class="view-page">
    ...
    <div class="info-panel">
        ...
        <div class="actions" style="display:flex; gap:0.5rem; margin-bottom:2rem; flex-wrap:wrap;">
            ...
            <button class="button ghost" id="shareBtn" data-url="<?php echo $shareUrl; ?>" style="flex:1;">Deli <span class="material-icons" style="font-size:1rem;margin-left:0.5rem;">link</span></button>
